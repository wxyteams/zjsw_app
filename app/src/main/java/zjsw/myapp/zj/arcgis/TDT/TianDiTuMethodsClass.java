package zjsw.myapp.zj.arcgis.TDT;
...
public class TianDiTuMethodsClass {
    private static final String tk = "4cbdd55df59581d39a029765c8567703";

    private static final List<String> SubDomain = Arrays.asList(new String[]{"t0", "t1", "t2", "t3", "t4", "t5", "t6", "t7"});

    private static final String URL_VECTOR_2000 = "http://{subDomain}.tianditu.gov.cn/DataServer?T=vec_c&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_VECTOR_ANNOTATION_CHINESE_2000 = "http://{subDomain}.tianditu.gov.cn/DataServer?T=cva_c&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_VECTOR_ANNOTATION_ENGLISH_2000 = "http://{subDomain}.tianditu.gov.cn/DataServer?T=eva_c&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_IMAGE_2000 = "http://{subDomain}.tianditu.gov.cn/DataServer?T=img_c&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_IMAGE_ANNOTATION_CHINESE_2000 = "http://{subDomain}.tianditu.gov.cn/DataServer?T=cia_c&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_IMAGE_ANNOTATION_ENGLISH_2000 = "http://{subDomain}.tianditu.gov.cn/DataServer?T=eia_c&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_TERRAIN_2000 = "http://{subDomain}.tianditu.gov.cn/DataServer?T=ter_c&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_TERRAIN_ANNOTATION_CHINESE_2000 = "http://{subDomain}.tianditu.gov.cn/DataServer?T=cta_c&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_VECTOR_MERCATOR = "http://{subDomain}.tianditu.gov.cn/DataServer?T=vec_w&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_VECTOR_ANNOTATION_CHINESE_MERCATOR = "http://{subDomain}.tianditu.gov.cn/DataServer?T=cva_w&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_VECTOR_ANNOTATION_ENGLISH_MERCATOR = "http://{subDomain}.tianditu.gov.cn/DataServer?T=eva_w&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_IMAGE_MERCATOR = "http://{subDomain}.tianditu.gov.cn/DataServer?T=img_w&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_IMAGE_ANNOTATION_CHINESE_MERCATOR = "http://{subDomain}.tianditu.gov.cn/DataServer?T=cia_w&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_IMAGE_ANNOTATION_ENGLISH_MERCATOR = "http://{subDomain}.tianditu.gov.cn/DataServer?T=eia_w&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_TERRAIN_MERCATOR = "http://{subDomain}.tianditu.gov.cn/DataServer?T=ter_w&x={col}&y={row}&l={level}&tk="+tk;

    private static final String URL_TERRAIN_ANNOTATION_CHINESE_MERCATOR = "http://{subDomain}.tianditu.gov.cn/DataServer?T=cta_w&x={col}&y={row}&l={level}&tk="+tk;
